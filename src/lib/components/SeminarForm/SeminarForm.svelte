  ...
  <form {action} method="post" use:enhance={{ result, error, pending }}>
    ...
    <div class="flex flex-col space-y-6 mb-8">
      <div class="grid grid-cols-2 gap-4">
        <label class="flex flex-col-reverse uppercase text-xs font-bold tracking-wider text-black"
          >Vorname
      ...
      <div class="grid grid-cols-2 gap-x-6">
        <label class="flex flex-col-reverse uppercase text-xs font-bold tracking-wider text-black grow-1"
          >Strasse
        ...
        <label class="flex flex-col-reverse uppercase text-xs font-bold tracking-wider text-black grow-none"
          >Hausnummer

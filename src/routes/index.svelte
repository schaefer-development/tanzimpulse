...
<section class="relative w-full slide-content border border-black overflow-hidden">
  <Skeleton>
    <div id="LOADING" class="absolute z-10 top-0 w-full slide-content bg-warmGray-200" slot="loading">
      <div class="flex justify-center items-center px-4 py-10 leading-6 transition ease-in-out duration-150">

	  ...
	  <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
		<DefaultCard>
		  ...
		  <p class="py-2">
			...
			<a class="hyperlink" rel="noreferrer" href="mailto:mail@joschaefer.com">mail@joschaefer.com</a><br />
			<a class="hyperlink" rel="noreferrer" href="http://www.joschaefer.com" target="_blank">joschaefer.com</a>
		  </p>
		</DefaultCard>
	  </div>
	</div>
